...
public class GrailsJobFactory extends AdaptableJobFactory implements ApplicationContextAware {
    ...
    public class GrailsJob implements InterruptableJob {
        ...
        public GrailsJob(Object job) {
            ...
            Method method = ReflectionUtils.findMethod(job.getClass(), GrailsJobClassConstants.EXECUTE);
            if (method == null) {
                method = ReflectionUtils.findMethod(job.getClass(), GrailsJobClassConstants.EXECUTE, new Class[]{Object.class});
            }
            if (method == null) {
                method = ReflectionUtils.findMethod(job.getClass(), GrailsJobClassConstants.EXECUTE, new Class[]{JobExecutionContext.class});
            }
